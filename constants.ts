...
export const MOCK_PRODUCTS: Product[] = [
  ...
  {
    id: 'p2', title: 'The Neo-Backpack', slug: 'neo-backpack', description: 'Weatherproof technical fabric with magnetic closures.', base_price: 14999, category_id: 'c3', image_url: 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?auto=format&fit=crop&q=80&w=800', other_images: ['https://images.unsplash.com/photo-1622560480605-d83c853bc5c3?auto=format&fit=crop&q=80&w=800'], is_active: true, variants: createVariants('p2', [{name: 'Stealth Black', hex: '#0A0A0A'}, {name: 'Ghost Gray', hex: '#A9A9A9'}]), tags: ['Techwear', 'Waterproof', 'Urban'], rating: 4.7, reviews_count: 89, is_new: true,
  ...
  {
    id: 'p6', title: 'Miniature Crossbody', slug: 'mini-crossbody', description: 'Compact essential bag with adjustable chain strap.', base_price: 12999, category_id: 'c2', image_url: 'https://images.unsplash.com/photo-1594223274512-ad4803739b7c?auto=format&fit=crop&q=80&w=800', other_images: ['https://images.unsplash.com/photo-1610290499424-9368d374d758?auto=format&fit=crop&q=80&w=800'], is_active: true, variants: createVariants('p6', [{name: 'Gold Glow', hex: '#C9A050'}, {name: 'Rose Dust', hex: '#BC8F8F'}]), tags: ['Mini', 'Summer', 'Chain'], rating: 4.9, reviews_count: 178,
  ...
  {
    id: 'p7', title: 'Brutalist Briefcase', slug: 'brutalist-briefcase', description: 'Square-cut professional bag for the modern creative.', base_price: 29999, category_id: 'c1', image_url: 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?auto=format&fit=crop&q=80&w=800', other_images: [], is_active: true, variants: createVariants('p7', [{name: 'Steel', hex: '#708090'}]), tags: ['Professional', 'Unisex', 'Architecture'], rating: 4.7, reviews_count: 29,
  ...
  {
    id: 'p8', title: 'Cloud Tote', slug: 'cloud-tote', description: 'Padded, ultra-lightweight fabric tote for daily use.', base_price: 7999, category_id: 'c1', image_url: 'https://images.unsplash.com/photo-1606170033648-5d55a3df3045?auto=format&fit=crop&q=80&w=800', other_images: [], is_active: true, variants: createVariants('p8', [{name: 'White Cloud', hex: '#FFFFFF'}, {name: 'Soft Blue', hex: '#ADD8E6'}]), tags: ['Lightweight', 'Everyday', 'Padded'], rating: 4.5, reviews_count: 312,
  ...
  {
    id: 'p9', title: 'Architectural Sling', slug: 'architectural-sling', description: 'Sharp-angled crossbody bag with hidden compartments.', base_price: 16999, category_id: 'c2', image_url: 'https://images.unsplash.com/photo-1591561954557-26941169b49e?auto=format&fit=crop&q=80&w=800', other_images: ['https://images.unsplash.com/photo-1591561954555-607ef358dcc2?auto=format&fit=crop&q=80&w=800'], is_active: true, variants: createVariants('p9', [{name: 'Ash', hex: '#B2B2B2'}, {name: 'Charcoal', hex: '#363636'}]), tags: ['Sling', 'Geometric', 'Modern'], rating: 4.8, reviews_count: 67,
