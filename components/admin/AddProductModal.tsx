...
import { generateContentWithImage, parseJsonResponse } from '../../lib/openrouter';
...
const AddProductModal: React.FC<AddProductModalProps> = ({ isOpen, onClose, onAddProduct }) => {
    ...
    const handleGenerateDetails = async () => {
        ...
        try {
            ...
            const response = await generateContentWithImage(prompt, base64Image, imageFile.type);
            ...
            setError("AI service temporarily unavailable. Please fill in the details manually.");
            
            // Provide fallback suggestions
            setTitle("Luxury Handbag");
            setDescription("A testament to timeless elegance and craftsmanship. This piece embodies the perfect balance of form and function.");
            setKeyPoints("Premium materials\nHandcrafted construction\nTimeless design\nVersatile styling");
            setSeoTags("luxury, handbag, leather, minimalist, fashion, accessories, premium");
            setAltText("Elegant luxury handbag with minimalist design");
        } finally {
            setIsLoadingAi(false);
        }
    };
