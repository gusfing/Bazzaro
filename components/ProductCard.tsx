...
const ProductCard: React.FC<ProductCardProps> = memo(({ product, onAddToCart, toggleWishlist, isWishlisted }) => {
          ...
          <AnimatePresence>
            <motion.img 
              ...
              style={{ 
                ...
                transition: 'transform 0.8s cubic-bezier(0.16, 1, 0.3, 1), filter 0.7s ease-in-out',
                aspectRatio: '2/3',
                contentVisibility: 'auto',
                containIntrinsicSize: '300px 450px'
              }}
              className={`absolute inset-0 w-full h-full object-cover grayscale group-hover:grayscale-0 z-20 ${imageLoaded ? 'blur-0' : 'blur-xl'}`}
              loading="lazy" 
              decoding="async"
            />
          </AnimatePresence>
