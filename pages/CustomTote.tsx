...
import { Upload, Type, Palette, Sparkles, Loader2, ShoppingBag } from 'lucide-react';
            ...
            <div className="px-8 py-12 max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                    ...
                    <div className="space-y-8 animate-reveal" style={{ animationDelay: '0.4s' }}>
                        ...
                        {/* AI Ideas */}
                        <ControlSection title="Need inspiration?" icon={<Sparkles size={18}/>}>
                             <div className="bg-brand-tan/10 p-4 rounded-xl border border-brand-tan/20">
                                <p className="text-xs text-brand-sepia mb-3 font-semibold">Describe a concept and let our AI generate design ideas for you.</p>
