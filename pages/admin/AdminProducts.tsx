...
const AdminProducts: React.FC = () => {
  ...
  const handleAddProduct = (newProduct: Omit<Product, 'id' | 'slug' | 'variants'>) => {
    const productToAdd: Product = {
      ...
      is_active: true,
      variants: [{
          id: `v${products.length + 1}-1`,
          product_id: `p${products.length + 1}`,
          size: 'OS',
          color: 'Default',
          stock_quantity: 10,
          sku: `BZR-${products.length + 1}`
      }]
    };
      ...
      <div className="p-8">
        <div className="flex justify-between items-center mb-8">
          ...
          <button
            ...
            className="bg-brand-gray-900 text-brand-gray-50 px-4 py-2 text-sm font-bold uppercase rounded-lg hover:bg-brand-gray-800 transition-colors flex items-center gap-2"
          >
